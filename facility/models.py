...
class Repair(models.Model):  # 维修
    ...
    baoxiu_staff_name = models.ForeignKey(User, on_delete=models.DO_NOTHING, verbose_name="报修人", related_name='aaa',
    ...
    repair_staff_name = models.ForeignKey(User, on_delete=models.DO_NOTHING, verbose_name="维修人", related_name='bbb',
                                          null=True, blank=True)
