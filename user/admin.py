...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'id', 'staff_type', "staff_gender", "staff_age", "staff_home", "staff_nationality",
                    "staff_tel", "email", "start_time", "id_card", "salary_pre_hour", 'is_staff', 'is_active',
                    'is_superuser')
...
class ProfileAdmin(admin.ModelAdmin):
    list_display = (
    'id', 'user', "staff_gender", "staff_age", "staff_home", "staff_nationality", "staff_tel", "start_time")


@admin.register(Salary)
class SalaryAdmin(admin.ModelAdmin):
    list_display = (
    "current_time", "staff_name", "attend_days", "leave_days", "absent_days", "business_days", "late_days",
