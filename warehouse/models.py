...
class PurchaseList(models.Model):  # 采购单
    ...
    apply_staff_name = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="申请人", null=True, blank=True,
                                         related_name='purchase_a')
    apply_date = models.DateField(auto_now_add=True, verbose_name="申请日期")
    sanction_staff_name = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="批准人", null=True,
                                            blank=True, related_name='purchase_b')
    ...
    buyer_name = models.ForeignKey(User, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name="采购员",
